      ...
      <div className="fixed top-0 left-0 w-full z-10 bg-gray-100 bg-opacity-75">
        ...
        >
          <div className="flex w-full lg:flex-wrap justify-between px-3">
            ...
            <div className="flex-grow navlink items-center lg:flex" id="navbarSupportedContent12" data-te-collapse-item>
              {/* logo */}
              <a className="mb-4 ml-2 mr-5 mt-3 flex items-center dark:text-black-200  lg:mb-0 lg:mt-0" href="/">
                <h1 className="text-2xl font-black [text-shadow:1px_1px_2px_var(--tw-shadow-color)] shadow-gray-600">
                  EDUMALL
                </h1>
              </a>
              {/* end logo */}
              ...
              <div className="relative mr-3 md:mr-0 px-4">
                ...
                <input
                  ...
                  className="bg-gray-100 bg-opacity-25 focus:bg-white border border-gray-300 text-gray-900 sm:text-sm outline-0	 rounded-lg focus:ring-blue-500 focus:border-blue-300 block w-full pl-10 p-2"
                  placeholder="Search..."
                />
              </div>
              <ul className="list-style-none mr-auto flex flex-col pl-0 lg:flex-row" data-te-navbar-nav-ref>
                {navItem.map((item, i) => (
                  <li className="mb-4 lg:mb-0 lg:pr-2" data-te-nav-item-ref key={i}>
                    <a
                      className="mb-4 ml-2 mr-5 mt-3 font-bold text-lg flex items-center  hover:text-black-400 hover:[text-shadow:1px_1px_2px_var(--tw-shadow-color)] shadow-gray-600 dark:text-black-200  lg:mb-0 lg:mt-0"
                      href={item.link}
            ...
            <div className="relative flex items-center ">
              <a
                className="mr-3 text-secondary-500 transition duration-200 hover:text-secondary-400 hover:ease-in-out focus:text-secondary-400 disabled:text-black/30 motion-reduce:transition-none"
                href="#"
              >
              ...
              {isLoggedIn ? (
                <div className="group inline-block relative">
                  <a className="bg-gray-300 text-gray-700 font-semibold rounded-full inline-flex items-center">
                    <Image
                      alt="avatar"
                      width={30}
                      height={40}
                      className="rounded-full lg:h-[50px] lg:w-[50px] w-[30px] h-[30px]"
                      src="/bgtim.webp"
                  ...
                  <ul className="absolute hidden lg:w-[200px] w-[120px] bg-white rounded shadow shadow-[rgba(0,0,3,0.3)_0_0_3px_3px] text-gray-700 pt-1 group-hover:block right-[3px] top-[45px]">
                    ...
                    <li className="">
                      <a className="bg-gray-100 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">
                        My learning
                      </a>
                    </li>
                    <li className="">
                      ...
                      <a
                        href="/user/register"
                        className='lg:hidden className="rounded-b bg-gray-100 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap"'
                      >
                        <i className="fa-solid fa-right-from-bracket px-2" style={{ color: "#ff0000" }} />
                      </a>
                    </li>
                  </ul>
                </div>
                ...
                <div className="flex items-center justify-center">
                  <div className="border w-fit rounded-xl m-3 shadow-sm" id="loginbtn">
                    <a
                      href="/user/login"
                      className="px-4 py-2 rounded-l-xl text-white m-0 bg-blue-500 hover:bg-red-600 transition"
                    >
                      Login
                    </a>
                    <a
                      href="/user/register"
                      className="px-4 py-2 rounded-r-xl bg-neutral-50 hover:bg-neutral-100 transition"
                    >
                      Register
                    </a>
                  </div>
                  <a href="/user/login" className=" lg:hidden">
                    <i className="fa-solid fa-right-to-bracket" style={{ color: "#000" }} />
                  </a>
                </div>
              )}
              <div
                className={`transition duration-500 ease-in-out left-0 ${openNav} lg:hidden fixed top-0 bg-white border-r-1 border border-black-900 z-1000 w-[200px] h-full`}
              >
                {/* nav link mobile*/}
                ...
                <div className="relative  p-2 w-[200px]">
                  <div className="absolute inset-y-0 left-3 pl-3 flex items-center pointer-events-none">
                    <svg
                      className="w-[15px] text-gray-500"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                ...
                <ul className="list-style-none p-2 w-[200px]" data-te-navbar-nav-ref>
                  {navItem.map((item, i) => (
                    <li className="mb-4 w-[200px]" data-te-nav-item-ref key={i}>
                      <a
                        className="text-sm hover:text-black-400 hover:[text-shadow:1px_1px_2px_var(--tw-shadow-color)] shadow-gray-600 dark:text-black-200"
                        href={item.link}
                        data-te-nav-link-ref
                      >
                        {item.name}
