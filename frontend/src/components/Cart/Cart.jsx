...
const Cart = () => {
  const {cartItems,
    ...
    showItem,
    setShowItem,showCart,setShowCart,
    handleRemoveItem, } = useContext(CartContext);
  return (
    <div className={`fixed transition duration-500 ease-in-out top-0 
        ...
        <ul className='flex flex-col pt-4 space-y-2'>
          {
            ...
            <div className="flex w-full justify-between">
              <div><a className="hover:[text-shadow:0px_0px_3px_var(--tw-shadow-color)] shadow-red-500 text-sm text-red-600 cursor-pointer" onClick={()=>handleRemoveItem(i)}>Remove</a></div>
